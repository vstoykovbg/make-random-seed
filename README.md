...
TLDR version: $really_random_number = decimal_from_dice($user_input_dice) ^  $random_number_from_PRNG ^ number_from_hash(sha512hash( join $random_string_input, $another_random_number_from_PRNG ));
